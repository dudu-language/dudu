...
protocol::FunctionDecl to_protocol(const FunctionDecl& function,
...
FunctionDecl from_protocol(const protocol::FunctionDecl& function,
                           const std::string& module_path, const std::string& owner = {},
