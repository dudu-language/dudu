...
`0.1.0-alpha.3`; until that tag is published, installation is from a checkout.
...
After `0.1.0-alpha.3` is published, the primary installer builds the immutable
tagged source archive locally, verifies its SHA-256 checksum, and installs an
atomic user-local toolchain:

```sh
curl --proto '=https' --tlsv1.2 -sSf \
  https://github.com/dudu-language/dudu/releases/download/v0.1.0-alpha.3/dudu-0.1.0-alpha.3-install.sh \
