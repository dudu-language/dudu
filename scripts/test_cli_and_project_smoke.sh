...
echo "CLI smoke: command surface"
...
grep -Fq "Generated by Dudu $toolchain_version (C++ schema 1)." \
    "$repo_root/build/duc_emit_simple.cpp"
grep -q "dudu: .*simple_program.dd:7:" "$repo_root/build/duc_emit_simple.cpp"
echo "CLI smoke: native APIs"
...
echo "CLI smoke: project lifecycle"
