...
expect_fail bad_enum_match_guard_after_covered --emit-cpp "unreachable duplicate case: Direction.North"
...
expect_fail bad_payload_enum_guard_after_covered --emit-cpp "unreachable duplicate case: Message.Move"
...
expect_fail bad_option_match_guard_after_covered --emit-cpp "unreachable duplicate case: Some"
