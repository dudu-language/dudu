...
expect_fail bad_legacy_native_import --check "native imports use .*from cpp import header.*from cpp.path import header"
expect_fail bad_dict_literal --emit-cpp "cannot assign set"
expect_fail bad_list_literal_type --emit-cpp "cannot assign list\\[bool\\] to list\\[i32\\]"
expect_fail bad_set_literal_type --emit-cpp "cannot assign set\\[i32\\] to set\\[str\\]"
expect_fail bad_dict_literal_key_type --emit-cpp "cannot assign dict\\[i32, i32\\] to dict\\[str, i32\\]"
expect_fail bad_dict_literal_value_type --emit-cpp "cannot assign dict\\[str, bool\\] to dict\\[str, i32\\]"
...
expect_fail bad_discard_read --check "discard binding '_' cannot be read"
...
expect_fail bad_native_explicit_std_template --emit-cpp "no native overload of std.get accepts 1 arguments"
expect_fail bad_native_ambiguous_overload --emit-cpp "ambiguous native overload of dudu_ambiguity.choose"
expect_fail bad_native_concrete_template_param --emit-cpp "parameter 1 expects dudu_compat.Concrete, got i32"
expect_fail bad_native_deleted_function --emit-cpp "function is deleted"
expect_fail bad_native_deleted_method --emit-cpp "function is deleted"
...
expect_fail bad_constexpr_body_calls_runtime --check "compile-time expression calls non-constexpr function: runtime_value"
