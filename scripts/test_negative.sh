...
expect_fail bad_conditional_missing_value --emit-cpp "conditional expression expects then, condition, and else values"
...
expect_fail bad_lambda_body --emit-cpp "lambda expression expects ':' body"
