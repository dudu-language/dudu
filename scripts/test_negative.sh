...
expect_fail bad_init_return --emit-cpp "__init__ cannot declare a return type"
expect_fail bad_del_param --emit-cpp "__del__ cannot take parameters"
...
expect_fail bad_del --check "unsupported Python feature: dynamic deletion"; expect_fail bad_local_import --check "unsupported Python feature: local imports"; expect_fail bad_match --check "unsupported Python feature: pattern matching"
...
expect_fail bad_staticmethod_self --check "@staticmethod methods cannot take self"
expect_fail bad_staticmethod_free --check "@staticmethod is only valid on methods"
