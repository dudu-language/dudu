...
| zlib | compression | C API, buffers, integer constants | planned | Simple portable C library probe. |
...
| curl | network | C API, callbacks, options | planned | Good callback and enum/value stress case. |
